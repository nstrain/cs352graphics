  ...
  for (var col = 1; col < cpaint.canvas.width - 1; col += 1) {
    for (var row = 1; row < cpaint.canvas.height - 1; row += 1) {
      ...
      if (vertical > 80 || horizontal > 80) {
        ...
        edges.data[((row * (cpaint.canvas.width * 4)) + (col * 4)) + 3] = 255;

      } else {
        edges.data[((row * (cpaint.canvas.width * 4)) + (col * 4)) + 0] = 0;
        edges.data[((row * (cpaint.canvas.width * 4)) + (col * 4)) + 1] = 0;
        edges.data[((row * (cpaint.canvas.width * 4)) + (col * 4)) + 2] = 0;
        edges.data[((row * (cpaint.canvas.width * 4)) + (col * 4)) + 3] = 255;
...
cpaint.sharpen = function (ev) {
  ...
  for (var col = 1; col < cpaint.canvas.width - 1; col += 1) {
    for (var row = 1; row < cpaint.canvas.height - 1; row += 1) {
      edges.data[((row * (cpaint.canvas.width * 4)) + (col * 4)) + 0] =
        (-1 / 8) * cpaint.imgData.data[(((row - 1) * (cpaint.canvas.width * 4)) + ((col - 1) * 4)) + 0] +
        (-1 / 8) * cpaint.imgData.data[(((row - 0) * (cpaint.canvas.width * 4)) + ((col - 1) * 4)) + 0] +
        (-1 / 8) * cpaint.imgData.data[(((row + 1) * (cpaint.canvas.width * 4)) + ((col - 1) * 4)) + 0] +
        (-1 / 8) * cpaint.imgData.data[(((row - 1) * (cpaint.canvas.width * 4)) + ((col - 0) * 4)) + 0] +
        (2) * cpaint.imgData.data[(((row - 0) * (cpaint.canvas.width * 4)) + ((col - 0) * 4)) + 0] +
        (-1 / 8) * cpaint.imgData.data[(((row + 1) * (cpaint.canvas.width * 4)) + ((col - 0) * 4)) + 0] +
        (-1 / 8) * cpaint.imgData.data[(((row - 1) * (cpaint.canvas.width * 4)) + ((col + 1) * 4)) + 0] +
        (-1 / 8) * cpaint.imgData.data[(((row + 0) * (cpaint.canvas.width * 4)) + ((col + 1) * 4)) + 0] +
        (-1 / 8) * cpaint.imgData.data[(((row + 1) * (cpaint.canvas.width * 4)) + ((col + 1) * 4)) + 0];
      edges.data[((row * (cpaint.canvas.width * 4)) + (col * 4)) + 1] =
        (-1 / 8) * cpaint.imgData.data[(((row - 1) * (cpaint.canvas.width * 4)) + ((col - 1) * 4)) + 1] +
        (-1 / 8) * cpaint.imgData.data[(((row - 0) * (cpaint.canvas.width * 4)) + ((col - 1) * 4)) + 1] +
        (-1 / 8) * cpaint.imgData.data[(((row + 1) * (cpaint.canvas.width * 4)) + ((col - 1) * 4)) + 1] +
        (-1 / 8) * cpaint.imgData.data[(((row - 1) * (cpaint.canvas.width * 4)) + ((col - 0) * 4)) + 1] +
        (2) * cpaint.imgData.data[(((row - 0) * (cpaint.canvas.width * 4)) + ((col - 0) * 4)) + 1] +
        (-1 / 8) * cpaint.imgData.data[(((row + 1) * (cpaint.canvas.width * 4)) + ((col - 0) * 4)) + 1] +
        (-1 / 8) * cpaint.imgData.data[(((row - 1) * (cpaint.canvas.width * 4)) + ((col + 1) * 4)) + 1] +
        (-1 / 8) * cpaint.imgData.data[(((row + 0) * (cpaint.canvas.width * 4)) + ((col + 1) * 4)) + 1] +
        (-1 / 8) * cpaint.imgData.data[(((row + 1) * (cpaint.canvas.width * 4)) + ((col + 1) * 4)) + 1];
      edges.data[((row * (cpaint.canvas.width * 4)) + (col * 4)) + 2] =
        (-1 / 8) * cpaint.imgData.data[(((row - 1) * (cpaint.canvas.width * 4)) + ((col - 1) * 4)) + 2] +
        (-1 / 8) * cpaint.imgData.data[(((row - 0) * (cpaint.canvas.width * 4)) + ((col - 1) * 4)) + 2] +
        (-1 / 8) * cpaint.imgData.data[(((row + 1) * (cpaint.canvas.width * 4)) + ((col - 1) * 4)) + 2] +
        (-1 / 8) * cpaint.imgData.data[(((row - 1) * (cpaint.canvas.width * 4)) + ((col - 0) * 4)) + 2] +
        (2) * cpaint.imgData.data[(((row - 0) * (cpaint.canvas.width * 4)) + ((col - 0) * 4)) + 2] +
        (-1 / 8) * cpaint.imgData.data[(((row + 1) * (cpaint.canvas.width * 4)) + ((col - 0) * 4)) + 2] +
        (-1 / 8) * cpaint.imgData.data[(((row - 1) * (cpaint.canvas.width * 4)) + ((col + 1) * 4)) + 2] +
        (-1 / 8) * cpaint.imgData.data[(((row + 0) * (cpaint.canvas.width * 4)) + ((col + 1) * 4)) + 2] +
        (-1 / 8) * cpaint.imgData.data[(((row + 1) * (cpaint.canvas.width * 4)) + ((col + 1) * 4)) + 2];
